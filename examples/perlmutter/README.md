...
At the top are the directives that control how the job is submitted.  Many of these you can leave as is.  (If you're morbidly curious, see [full documentation on the `slurm` command](https://slurm.schedmd.com/slurm.html).)  The ones you are most likely to want to change are
