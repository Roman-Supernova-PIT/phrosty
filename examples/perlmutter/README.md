...
A note: If you are using the slurm demo, sbatch from the directory that contains phrosty, not from within the phrosty directory itself. Go one above. When you sbatch from a particular folder, it takes that folder to be `/home` in the container. 